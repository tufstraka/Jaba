...
import { idlFactory } from './jaba_backend.did.js';
export { idlFactory } from './jaba_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_JABA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./jaba_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the jaba_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./jaba_backend.did.js")._SERVICE>}
 */
export const jaba_backend = createActor(canisterId);
